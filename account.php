      ...
      <div class="col-lg-3">
        <div class="card p-3">
          ...
          <nav class="nav flex-column nav-pills account-nav">
            <a class="nav-link active" href="#"><i class="fas fa-user-circle"></i> My Profile</a>
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <form method="POST" action="verify.php">
              ...
              <button type="submit" name="update_profile" class="btn btn-gradient">Save Profile Changes</button>
            </form>
