...
CREATE TABLE IF NOT EXISTS `product_specs` (
  ...
  KEY `product_id` (`product_id`)
) ENGINE=MyISAM AUTO_INCREMENT=906 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
(820, 34, 'Hard Disk Interface', 'USB 2.0/3.0', 'Key Specs', 2),
(819, 34, 'Digital Storage Capacity', '2 TB', 'Key Specs', 1),
(818, 34, 'Item Weight', '‎181 g', 'Detailed Specs', 23),
(817, 34, 'Included Components', '‎Seagate® Expansion portable hard drive, 18-inch (45.72cm) USB 3.0 cable, Quick start guide, Limited Warranty: APAC - 3 years, Rescue Data Recovery Services', 'Detailed Specs', 22),
(816, 34, 'Hardware Platform', '‎Mac, PC', 'Detailed Specs', 21),
(814, 34, 'Hard Disk Rotational Speed', '‎5400 RPM', 'Detailed Specs', 19),
(815, 34, 'Wattage', '3600', 'Detailed Specs', 20),
(813, 34, 'Hard Drive Interface', '‎USB 2.0/3.0', 'Detailed Specs', 18),
(812, 34, 'Hard Disk Description', '‎Mechanical Hard Disk', 'Detailed Specs', 17),
(811, 34, 'Item model number', '‎STKM2000400', 'Detailed Specs', 16),
(810, 34, 'Product Dimensions', '‎8 x 1.5 x 11.7 cm; 181.44 g', 'Detailed Specs', 15),
(809, 34, 'Item Width', '‎1.5 Centimeters', 'Detailed Specs', 14),
(808, 34, 'Item Height', '‎11.7 Centimeters', 'Detailed Specs', 13),
(807, 34, 'Form Factor', '‎2.5-inch', 'Detailed Specs', 12),
(806, 34, 'Colour', '‎Black', 'Detailed Specs', 11),
(805, 34, 'Manufacturer', '‎Seagate Technology (Thailand) Limited. India Customer Care No: 18003092525, Seagate Technology (Thailand) Limited. India Customer Care No: 18003092525', 'Detailed Specs', 10),
(798, 35, 'Connectivity Technology', 'SATA', 'Key Specs', 3),
(797, 35, 'Hard Disk Interface', 'Serial ATA', 'Key Specs', 2),
(796, 35, 'Digital Storage Capacity', '4 TB', 'Key Specs', 1),
(795, 35, 'Item Weight', '‎460 g', 'Detailed Specs', 25),
(794, 35, 'Included Components', '‎Internal Hard disk', 'Detailed Specs', 24),
(793, 35, 'Hardware Platform', '‎Desktop', 'Detailed Specs', 23),
(792, 35, 'Wattage', '125', 'Detailed Specs', 22),
(788, 35, 'RAM Size', '‎4 TB', 'Detailed Specs', 18),
(789, 35, 'Hard Drive Size', '‎4 TB', 'Detailed Specs', 19),
(790, 35, 'Hard Disk Description', '‎Mechanical Hard Disk', 'Detailed Specs', 20),
(791, 35, 'Hard Disk Rotational Speed', '‎5400 RPM', 'Detailed Specs', 21),
(787, 35, 'Item model number', '‎ST4000DMB04', 'Detailed Specs', 17),
(786, 35, 'Product Dimensions', '‎14.7 x 10.16 x 2 cm; 460 g', 'Detailed Specs', 16),
(785, 35, 'Item Width', '‎4 Inches', 'Detailed Specs', 15),
(784, 35, 'Item Height', '‎0.79 Inches', 'Detailed Specs', 14),
(783, 35, 'Form Factor', '‎3.5-inch', 'Detailed Specs', 13),
(782, 35, 'Colour', 'Black', 'Detailed Specs', 12),
(781, 35, 'Series', '‎BarraCuda', 'Detailed Specs', 11),
(780, 35, 'Manufacturer', '‎Seagate, Seagate, Cal-Comp Electronics (Thailand) Public Co Ltd. 60 Moo 8, Sethakij Road, Klong Maduea,KratoomBan, Samusakorn,74110,THAILAND Techman Electronics (Thailand) Co. Ltd. No. 236-237 Moo 2 Tambol Nongchark, Amphur, Banbung, Chonburi, Thailand 2', 'Detailed Specs', 10),
(904, 36, 'Installation Type', 'Internal Hard Drive', 'Key Specs', 9),
(905, 36, 'Colour', 'Black 990 PRO 4TB', 'Key Specs', 10),
(902, 36, 'Hard Disk Description', 'Solid State Drive', 'Key Specs', 7),
(903, 36, 'Compatible Devices', 'Desktop, Gaming Console, Laptop', 'Key Specs', 8),
(901, 36, 'Hard Disk Form Factor', '2.5 Inches', 'Key Specs', 6),
(896, 36, 'Digital Storage Capacity', '4 TB', 'Key Specs', 1),
(897, 36, 'Hard Disk Interface', 'Solid State', 'Key Specs', 2),
(898, 36, 'Connectivity Technology', 'PCI Express NVMe', 'Key Specs', 3),
(899, 36, 'Brand', 'Samsung', 'Key Specs', 4),
(900, 36, 'Special Feature', 'Backward Compatible', 'Key Specs', 5),
(895, 36, 'Item Weight', '‎9.07 g', 'Detailed Specs', 26),
(893, 36, 'Manufacturer', '‎Samsung', 'Detailed Specs', 24),
(894, 36, 'Country of Origin', '‎Republic of Korea', 'Detailed Specs', 25),
(892, 36, 'Included Components', '‎SSD , User manual', 'Detailed Specs', 23),
(891, 36, 'Hardware Platform', '‎PC', 'Detailed Specs', 22),
(890, 36, 'Hard Drive Interface', '‎Solid State', 'Detailed Specs', 21),
(889, 36, 'Hard Disk Description', '‎Solid State Drive', 'Detailed Specs', 20),
(885, 36, 'Item Width', '‎0.87 Inches', 'Detailed Specs', 16),
(886, 36, 'Product Dimensions', '‎8 x 2.21 x 0.23 cm; 9.07 g', 'Detailed Specs', 17),
(888, 36, 'Hard Drive Size', '‎4 TB', 'Detailed Specs', 19),
