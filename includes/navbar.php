      ...
      <ul class="navbar-nav me-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            ?>
              <li><a class="dropdown-item" href="pages/category.php?id=<?php echo $category['id']; ?>"><?php echo $category['name']; ?></a></li>
            <?php endforeach; ?>
          </ul>
        </li>
      </ul>
      ...
      <ul class="navbar-nav">
        <?php if (isLoggedIn()): ?>
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="pages/my-account.php">My Account</a></li>
