...
-- Update your categories to have parent-child relationships
-- Example: Make "Storage" a top-level category and add "SSD" as its subcategory
UPDATE categories SET parent_id = NULL WHERE name IN ('Processor', 'Graphics Card', 'Motherboard', 'RAM', 'Storage', 'Power Supply', 'Cabinet', 'Cooling System', 'Monitor', 'Keyboard', 'Mouse');

-- Add some subcategories (example)
INSERT INTO categories (name, parent_id) VALUES
('SSD', (SELECT id FROM categories WHERE name = 'Storage')),
('HDD', (SELECT id FROM categories WHERE name = 'Storage')),
('NVMe', (SELECT id FROM categories WHERE name = 'Storage')),
('Air Cooler', (SELECT id FROM categories WHERE name = 'Cooling System')),
('Liquid Cooler', (SELECT id FROM categories WHERE name = 'Cooling System'));
